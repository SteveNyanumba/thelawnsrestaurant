...
<section class="home-slider owl-carousel">
  ...
  <section class="nos-about d-md-flex">
      <div class="one-half img" style="background-image: url(images/about.jpg);"></div>
      <div class="one-half nos-animate">
          <div class="overlap">
          <div class="heading-section nos-animate ">
  ...
  <section class="nos-section nos-services">
      <div class="container">
          <div class="row">
        <div class="col-md-4 nos-animate">
      ...
      <div class="container">
          <div class="row align-items-center">
              <div class="col-md-6 pr-md-5">
                  <div class="heading-section text-md-right nos-animate">
                <span class="subheading">Discover</span>
  ...
  <section class="nos-counter nos-bg-dark img" id="section-counter" style="background-image: url(images/bg_2.jpg);" data-stellar-background-ratio="0.5">
          <div class="overlay"></div>
    <div class="container">
      <div class="row justify-content-center">
          <div class="col-md-10">
              <div class="row">
                <div class="col-md-6 col-lg-3 d-flex justify-content-center counter-wrap nos-animate">
  ...
  <section class="nos-section">
      <div class="container">
        ...
        <div class="col-md-7 heading-section nos-animate text-center">
            <span class="subheading">Discover</span>
  ...
  <section class="nos-gallery">
      <div class="container-wrap">
          <div class="row no-gutters">
                  <div class="col-md-3 nos-animate">
  ...
  <section class="nos-menu">
      <div class="container">
          <div class="row justify-content-center mb-5">
        <div class="col-md-7 heading-section text-center nos-animate">
            <span class="subheading">Discover</span>
          ...
          <div class="row d-md-flex">
              <div class="col-lg-12 nos-animate p-md-5">
                  <div class="row">
                <div class="col-md-12 nav-link-wrap mb-5">
                  <div class="nav nos-animate nav-pills justify-content-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <div class="col-md-12 d-flex align-items-center">
                  ...
                  <div class="tab-content nos-animate" id="v-pills-tabContent">
  ...
  <section class="nos-section img" id="nos-testimony" style="background-image: url(images/bg_1.jpg);"  data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 heading-section text-center nos-animate">
      ...
      <div class="container-wrap">
        <div class="row d-flex no-gutters">
          <div class="col-lg align-self-sm-end nos-animate">
            <div class="testimony">
               <blockquote>
  ...
  <section class="nos-appointment">
      ...
      <div class="container-wrap">
          <div class="row no-gutters d-md-flex align-items-center">
              ...
              <div class="col-md-6 appointment nos-animate">
